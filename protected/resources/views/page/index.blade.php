...
<div class="box box-primary">
  <div class="box-header">
    <div class="row">
      <div class="col-md-12">
        <a href="{{ url('page/create') }}" class="btn btn-md btn-primary btn-flat pull-right" data-toggle="tooltip" title="Tambah Data"><i class="fa fa-plus"></i></a>
      </div>
    </div>
  </div><!-- /.box-header -->
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        <table class="table table-condensed table-bordered table-striped" id="tb_page" style="width: 100%"> 
          <thead>
            <tr>
              <th>No</th>
...
<script type="text/javascript">
  var tb_page = $('#tb_page').dataTable( {
    processing: true,
        serverSide: true,
        ajax: '{{ url("page/listing") }}',
        columns: [
  ...
  $('#tb_page_filter input').unbind();
  $('#tb_page_filter input').bind('keyup', function(e) {
    if(e.keyCode == 13) {
      tb_page.fnFilter(this.value);
    }
  })
