       ...
       <div class="content  content-boxed">
         <div class="row">
           ...
           <ol class="col-sm-6 text-left breadcrumb">
             <li><a href="#">Home</a></li>
             <li class="active">{{ trans('label.search') }}</li>
           </ol>
                ...
                <div class="blog-post pd-30">
                    <div class="post-head ">
                        <div class="head-content">
                            <h2 id="head_post" class="header-widget-page">{{ trans('label.search') }}</h2>
                        </div>
                    </div>
                    <!-- isi -->
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12 post-row post-list-data">
                                ...
                                <div class="post-content">
                                    <div class="date-news"><i class="fa fa-clock-o"></i>
                                        ...
                                        {{ Date::now()->format('j F Y') }} | {{ $data->$kategori }}
                                    </div>
                                    <p>{{ strip_tags(substr($data->$konten,0,200)) }} <a class="read-more" href="{{ url('posts/'.$data->$slug) }}">{{ trans('label.baca') }}...<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a></p>
                                </div>
                        ...
                        @else
                            <div class="col-md-12 post-row post-list-data">
                                <center><i>No Data to Display</i></center><br>
                            </div>
                        @endif
                    </div>
                    <div class="row">
