       ...
       <div class="content  content-boxed">
         <div class="row">
           ...
           <ol class="col-sm-6 text-left breadcrumb">
             ...
             <li class="active">{{ trans('label.pengaduan')}}</li>
           </ol>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <div class="form-material form-material-primary">
                                <input class="form-control" type="text" id="firstname" name="firstname" placeholder="Enter your firstname.." required="required">
                                <input class="form-control" type="hidden" id="perihal" name="perihal" value="PENGADUAN MASYARAKAT" placeholder="Enter your firstname..">
                                <label for="firstname">{{ trans('label.nama_depan')}}</label>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-material form-material-primary">
                                <input class="form-control" type="text" id="lastname" name="lastname" placeholder="Enter your lastname.." required="required">
                                <label for="lastname">{{ trans('label.nama_belakang')}}</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
