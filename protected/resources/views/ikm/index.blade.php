...
<div class="box box-primary">
  <div class="box-header">
    <div class="row">
      <div class="col-md-12">
        <a href="{{ url('ikm/create') }}" class="btn btn-md btn-primary btn-flat pull-right" data-toggle="tooltip" title="Tambah Data"><i class="fa fa-plus"></i></a>
      </div>
    </div>
  </div><!-- /.box-header -->
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        <table class="table table-condensed table-bordered table-striped" id="tb_ikm" style="width: 100%"> 
          <thead>
            <tr>
              <th>No</th>
...
<script type="text/javascript">
  var tb_ikm = $('#tb_ikm').dataTable( {
    processing: true,
        serverSide: true,
        ajax: '{{ url("ikm/listing") }}',
        columns: [
  ...
  $('#tb_ikm_filter input').unbind();
  $('#tb_ikm_filter input').bind('keyup', function(e) {
    if(e.keyCode == 13) {
      tb_ikm.fnFilter(this.value);
    }
  })
  ...
  function delete_data(bulan,tahun){
      $.confirm({
        title: 'Hapus Data',
        type: 'red',
        icon: 'fa fa-warning',
