...
<div class="box box-primary">
  <div class="box-header">
    <div class="row">
      <div class="col-md-12">
        <a href="{{ url('tpi/create') }}" class="btn btn-md btn-primary btn-flat pull-right" data-toggle="tooltip" title="Tambah Data"><i class="fa fa-plus"></i></a>
      </div>
    </div>
  </div><!-- /.box-header -->
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        <table class="table table-condensed table-bordered table-striped" id="tb_tpi" style="width: 100%"> 
          <thead>
            <tr>
              <th>No</th>
...
<script type="text/javascript">
  var tb_tpi = $('#tb_tpi').dataTable( {
    processing: true,
        serverSide: true,
        ajax: '{{ url("tpi/listing") }}',
        columns: [
  ...
  $('#tb_tpi_filter input').unbind();
  $('#tb_tpi_filter input').bind('keyup', function(e) {
    if(e.keyCode == 13) {
      tb_tpi.fnFilter(this.value);
    }
  })
